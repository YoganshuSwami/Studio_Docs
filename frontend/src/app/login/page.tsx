        ...
        <div className="relative z-10 w-full max-w-lg mt-auto mb-10">
          <div className="p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
            <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
              Master Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-rose-300">Documents.</span>
            </h1>
            <p className="text-slate-300 text-base mb-8 leading-relaxed">
              The premium workspace for professionals. Edit, sign, and manage PDFs with absolute precision and security.
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative overflow-y-auto">
        <div className="w-full max-w-md flex flex-col justify-center min-h-full py-8">
          ...
          <div className="text-center lg:text-left mb-8">
            ...
            <p className="text-slate-500">Access your professional workspace.</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-sm font-medium text-rose-600 hover:text-rose-700 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-slate-600 mt-8">
            ...
            <Link href="/register" className="font-semibold text-rose-600 hover:text-rose-700 hover:underline transition-all">
              Sign up
            </Link>
          </p>
